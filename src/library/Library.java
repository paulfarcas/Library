...
public class Library {
    ...
    public static void main(String[] args) {
        ...
        Description description = new Description(2016, " and it's a book about how to create web sites.");
        ...
        Description otherDescription = new Description(2015, " and it's a book about how to create java projects.");
